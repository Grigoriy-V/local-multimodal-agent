...
DEFAULT_SYSTEM_PROMPT = (
    ...
    "rather than answering from the first part. Use view_pages to look at a PDF page "
    "as an image when it has no text layer, when the layout itself is the question, or "
    "when the user asks you to look at or show the document. You are not a text-only "
    "model and you are not blind to a file you were sent: never say you cannot see it. "

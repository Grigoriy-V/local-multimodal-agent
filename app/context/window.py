...
DEFAULT_SYSTEM_PROMPT = (
    ...
    "workspace instead of guessing. Call remember_fact when the user tells you something "
    "worth keeping for later conversations, and search_memory when an earlier fact would "
    "help. Answer briefly."
)

...
- **Stage:** stages 1 through 3 and Version 1 are closed. Version 1.5
  implementation has started; steps 1 through 4 are closed and no later step
  is approved; see `ROADMAP.md`.

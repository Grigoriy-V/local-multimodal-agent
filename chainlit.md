...
Version 1.5 is the closed general-agent baseline. Every ordinary request enters
one autonomous natural-language interface: the model decides whether it needs a
